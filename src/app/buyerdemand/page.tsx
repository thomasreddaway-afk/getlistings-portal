...
import { CheckCircle, Home, Building, Map, ArrowRight } from 'lucide-react';
    ...
    <DemoLayout currentPage="buyerdemand">
      <div className="flex-1 overflow-auto bg-gradient-to-b from-blue-50/30 to-white">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-8 pt-20 pb-16">
            ...
            <div className="mt-10 flex items-center space-x-6">
              <button className="px-8 py-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/20">View Buyer Packages</button>
              <button className="px-8 py-4 text-gray-700 font-semibold hover:text-gray-900 transition-colors flex items-center space-x-2">
        ...
        <div className="max-w-5xl mx-auto px-8 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:border-blue-300 hover:shadow-xl transition-all">
              <div className="p-8">
                ...
                <button className="w-full py-3 border-2 border-gray-200 text-gray-700 font-semibold rounded-xl hover:border-blue-500 hover:text-blue-600 transition-colors">Request Buyers</button>
              </div>
            </div>
            <div className="bg-white rounded-2xl border-2 border-blue-500 overflow-hidden shadow-xl relative">
              <div className="absolute top-0 left-0 right-0 bg-blue-500 text-white text-xs font-bold text-center py-1.5 uppercase tracking-wide">Most Popular</div>
              <div className="p-8 pt-12">
                ...
                <button className="w-full py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/20">Request Buyers</button>
              </div>
            </div>
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl overflow-hidden shadow-xl text-white">
              <div className="p-8">
                ...
                <button className="w-full py-3 bg-white text-gray-900 font-semibold rounded-xl hover:bg-gray-100 transition-colors">Request Buyers</button>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 py-24">
          <div className="max-w-4xl mx-auto px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-12">
              <button className="px-10 py-5 bg-white text-blue-700 font-semibold rounded-xl hover:bg-blue-50 transition-colors shadow-xl text-lg">Request Buyer Demand</button>
